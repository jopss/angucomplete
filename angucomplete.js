    ...
    return {
        ...
        link: function($scope, elem, attrs) {
            ...
            $scope.searchTimerComplete = function(str) {
                ...
                if (str.length >= $scope.minLength) {
                    if ($scope.localData) {
                        ...
                        if ($scope.action !== null && typeof $scope.action === "function") {
								$scope.$watch(function () {return $scope.dataField;}, 
										function (newValue, oldValue) {
												if (angular.isUndefined(newValue)) return;
												if (newValue !== oldValue) {
														$scope.searching = false;
														$scope.processResults($scope.dataField, str);
												}
								});
								$scope.action(str); //invoke function
						}
						else {
								$http.get($scope.url + str, {}).
										...
										error(function (data, status, headers, config) {
												console.log("error angucomplete: " + result);
										});
						}
                    }
                }
            ...
            $scope.selectResult = function(result) {
                ...
                if ($scope.selectedAction !== null && typeof $scope.selectedAction === "function") {
						$scope.selectedAction(result); //invoke function
				} else {
